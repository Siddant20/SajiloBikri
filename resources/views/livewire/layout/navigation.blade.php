        ...
        <div class="flex justify-between h-16">
            ...
            @auth
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-primary-button class="bg-yellow-300 hover:bg-yellow-100 text-black mx-2"> Post Ad
                        +</x-primary-button>
            ...
            @else
                <div class="flex items-center">
                    <x-primary-button class="bg-yellow-300 hover:bg-yellow-200 text-black mx-2"> Post Ad
                        +</x-primary-button>
